...
#
#     PHX_SERVER=true bin/trading_swarm start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :trading_swarm, TradingSwarmWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :trading_swarm, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :trading_swarm, TradingSwarm.Mailer,
