...
config :trading_swarm, TradingSwarmWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "glUfVxmKgLKW7Gy/25sdPCgFNht7a9XpAlgXs6ta87OrhDF3a8boiFQ96bRBniat",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:trading_swarm, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:trading_swarm, ~w(--watch)]}
  ]
...
config :trading_swarm, TradingSwarmWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/trading_swarm_web/(?:controllers|live|components|router)/?.*\.(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :trading_swarm, dev_routes: true
