defmodule TradingSwarmWeb.TradingLive.Index do
  ...
  def handle_event("sort_trades", %{"sort_by" => sort_by}, socket) do
    socket = 
      ...
      |> assign(:trades, load_trades(socket.assigns.status_filter, socket.assigns.symbol_filter, sort_by))
  ...
  defp update_trading_statistics(socket, trade_data) do
    ...
    updated_stats = %{current_stats |
      ...
      total_volume: Decimal.add(current_stats.total_volume, 
        Decimal.new(trade_data[:volume] || "0")),
      total_pnl: Decimal.add(current_stats.total_pnl, 
